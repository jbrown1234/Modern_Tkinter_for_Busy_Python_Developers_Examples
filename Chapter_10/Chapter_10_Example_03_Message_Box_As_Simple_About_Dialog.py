...
def show_about(*args):
    print('About...')
    messagebox.showinfo("About...", "Expanded menu example updated to have a messagebox provide the app info.")
    messagebox._show(title="Title", message="message", _icon='info', _type='okcancel')
